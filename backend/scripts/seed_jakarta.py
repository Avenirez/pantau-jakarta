...
JAKARTA_DATA = {
    "JAKARTA PUSAT": {
        ...
        "KEMAYORAN": ["KEMAYORAN", "GUNUNG SAHARI SELATAN", "UTAN PANJANG", "HARAPAN MULYA", "KEBON KOSONG", "CEMPAKA BARU", "SUMUR BATU", "SERDANG"],
    ...
    "JAKARTA SELATAN": {
        ...
        "PANCORAN": ["PANCORAN", "KALIBATA", "RAWAJATI", "DUREN TIGA", "CIKOKO", "PENGADEGAN"],
